...
print(net.res_load)
#print(net.res_line)
print(net.res_gen.to_csv("Part5/resgen5_4_withoutN104N203.csv"))
pf_res_plotly(net, aspectratio=(1,1),filename="Part5/Grid_withoutN104N203.html");
#,filename="Part5/Grid_withoutM3.html"
