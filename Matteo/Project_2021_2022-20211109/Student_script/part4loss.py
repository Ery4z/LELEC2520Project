...
LOAD_N205 = pp.create_load(net, bus=N205, p_mw=460.0, q_mvar=230.0, name="N205", in_service=True, max_p_mw=360., min_p_mw=360., max_q_mvar=180., min_q_mvar=180., controllable = True)
...
G6=pp.create_gen(net, p_mw=770.34, max_q_mvar=212.61, min_q_mvar=-250.0, sn_mva=1000.0, bus=M6, vm_pu=1.0100, name="M6", slack=False, in_service=True, min_p_mw=0., max_p_mw=850., controllable = True)
...
G8=pp.create_gen(net, p_mw=174.0, max_q_mvar=9999.0, min_q_mvar=-999.0, sn_mva=1000.0, bus=N14, vm_pu=1.0929, name="N14", slack=True, in_service=True, min_p_mw=0., max_p_mw=2450., controllable = True)
...
after_line=df.read_csv('Part4/resline4_2.csv')
before_line=df.read_csv('Part4/resline4_2_basecase.csv')

result_line=after_line['p_from_mw']-before_line['p_from_mw']
print(result_line)

#p_hv_mw
after_trafo=df.read_csv('Part4/resTRAFO4_2.csv')
before_trafo=df.read_csv('Part4/resTRAFO_basecase.csv')

result_trafo=after_trafo['p_hv_mw']-before_trafo['p_hv_mw']
print(result_trafo)

#print(net.res_trafo.to_csv("Part4/resTRAFO_basecase.csv"))
#print(net.res_line.to_csv("Part4/resline4_2.csv"))
#pf_res_plotly(net, aspectratio=(1,1),filename="Part2/Grid4_2.html");
#,filename="Part3/Grid_noshunts.html"
