...
pp.create_poly_cost(net, element=G1, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G2, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G3, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G4, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G5, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G6, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G7, et="gen", cp1_eur_per_mw=1)
pp.create_poly_cost(net, element=G8, et="gen", cp1_eur_per_mw=1)

#pp.create_poly_cost(net,element=LOAD_N204, et="load", cp1_eur_per_mw=-2)


pp.runopp(net,verbose=True)
print(net.res_gen.to_csv("Part6/resgen.csv"))
print(net.res_load)
print(net.res_trafo.loc[15])
pf_res_plotly(net, aspectratio=(1,1));
#,filename="Part5/Grid_withoutN104N203.html"
