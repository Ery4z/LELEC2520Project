...
G2 = pp.create_gen(net, p_mw=600.0, max_q_mvar=696.53, min_q_mvar=-250.0, sn_mva=1000.0, bus=M2, vm_pu=0.99958*1.05, name="M2", slack=False, in_service=True, min_p_mw=0., max_p_mw=850., controllable = True)
...
""" print(net.res_bus.to_csv("resbus_base")) 
print(net.res_line.to_csv("resline_base.csv")) """
#print(net.res_gen.to_csv("Part3/resgen_noshunts.csv"))     
#print(net.res_gen)
#pf_res_plotly(net, aspectratio=(1,1),filename="Part3/Grid_noshunts.html");
print(net.res_bus)
print(net.res_gen)
"""sum_of_cols=net.res_bus.sum(axis=0)
print(sum_of_cols)
"""
sum_of_cols_gen=net.res_gen.sum(axis=0)
print(sum_of_cols_gen)
